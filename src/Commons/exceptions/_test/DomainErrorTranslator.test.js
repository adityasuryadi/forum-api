...
describe('DomainErrorTranslator', () => {
  it('should translate error correctly', () => {
    ...
    .toStrictEqual(new InvariantError('refresh token harus string'));
    expect(DomainErrorTranslator.translate(new Error('CREATE_THREAD.NOT_DOING_AUTHENTICATION')))
    ...
    .toStrictEqual(new InvariantError('tidak dapat melakukan komentar karena properti yang dibutuhkan tidak ada'));
    expect(DomainErrorTranslator.translate(new Error('CREATE_COMMENT.NOT_MEET_DATA_TYPE_SPECIFICATION')))
    .toStrictEqual(new InvariantError('tidak dapat melakukan komentar karena tipe data tidak sesuai'));
